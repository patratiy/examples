...
$date_create = \DateTime::createFromFormat('d.m.Y H:i:s', $arResult['DATE_CREATE']);
...
<tr>
    ...
    <td style="vertical-align: top;padding-bottom: 25px;line-height: 1.4;">
        ...
        <!--+7 495 9843122<br>-->
        <!--Пн - Вс с 08:00 до 23:00<br>-->
        Можно забрать до <?=toStringM($arResult['DATE_INSERT']->add("7 day")->format('d.m'));?><br>
        Стоймость доствки: <?=$arResult['SHIPMENT'][0]['PRICE_DELIVERY_FORMATED'];?><br>
    </td>
</tr>
<?
}
